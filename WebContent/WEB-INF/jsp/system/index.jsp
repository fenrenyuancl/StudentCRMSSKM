   ...
   <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"年级信息管理",
							"menus":[
									{"menuid":"21","menuname":"年级列表","icon":"icon-world","url":"../grade/list"},
								]
						},
						{"menuid":"3","icon":"","menuname":"班级信息管理",
							"menus":[
									{"menuid":"21","menuname":"班级列表","icon":"icon-house","url":"../clazz/list"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">【疯人愿】学生信息管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; SWU By 疯人愿</div>
    </div>
