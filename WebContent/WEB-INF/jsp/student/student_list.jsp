	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "是否确定删除学生信息？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<c:if test="${userType == 1 }">
			...
			所属班级：
			<select id="search-clazz-id" class="easyui-combobox">
	...
	<div id="addDialog" style="padding: 10px;">  
   		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	...
	    	<tr >
	    			<td>预览头像:</td>
	    			<td>
	    			  	<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 200px;" title="照片" src="/SummerTest3/photo/student.jpg" />
	    			</td>
	    		</tr><tr >
	    			<td>学生头像:</td>
	    			<td>
	    	...
	    	<table id="addTable2" cellpadding="8">
	    		<input id="add_photo"   type="hidden" name="photo" value="/SummerTest3/photo/student.jpg"  />
	    		<tr >
	    			<td>学生姓名:</td>
	    			<td>
	    		...
	    		<tr >
	    			<td>登录密码:</td>
	    			<td>
	    				<input id="add_password"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="password" data-options="required:true, missingMessage:'请填写登陆密码'"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生性别:</td>
	...
	<div id="editDialog" style="padding: 10px">
	    <form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	...
	    	<tr >
	    			<td>预览头像:</td>
	    			<td>
	    			  	<img id="edit-photo-preview" alt="照片" style="max-width: 100px; max-height: 200px;" title="照片" src="/SummerTest3/photo/student.jpg" />
	    			</td>
	    		</tr><tr >
	    			<td>学生头像:</td>
	    			<td>
	    	...
	    	<table id="editTable2" cellpadding="8">
	    		<input id="edit_photo"   type="hidden" name="photo" value="/SummerTest3/photo/student.jpg"  />
	    		<tr >
	    			<td>学生姓名:</td>
	    			<td>
	    		...
	    		<tr >
	    			<td>登录密码:</td>
	    			<td>
	    				<input id="edit_password"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="password" data-options="required:true, missingMessage:'请填写登陆密码'"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生性别:</td>
