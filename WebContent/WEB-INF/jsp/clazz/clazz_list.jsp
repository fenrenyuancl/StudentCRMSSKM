	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果班级下存在学生信息则无法删除，需删除班级下属的学生信息？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			所属年级：
			<select id="search-grade-id" class="easyui-combobox">
	...
	<div id="addDialog" style="padding: 10px;">  
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><input id="add_remark" style="width: 256px; height: 150px;" class="easyui-textbox" type="text" name="remark" data-options="multiline:true"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<tr >
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><input id="edit_remark" style="width: 256px; height: 150px;" class="easyui-textbox" type="text" name="remark" data-options="multiline:true"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
